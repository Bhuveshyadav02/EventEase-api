...
The backend of this project is deployed on Vercel. You can access it [here](https://event-ease-api.vercel.app).

**Production Deployment:** https://event-ease-api.vercel.app
